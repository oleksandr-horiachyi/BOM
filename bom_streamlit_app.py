...
# Footer
st.markdown('''<a href="https://oleksandr-horiachyi.github.io/BOM/help.html#tool1" target="_blank" class="help-btn" title="Help &amp; Documentation">❓</a>''', unsafe_allow_html=True)
